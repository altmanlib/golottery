...
| 编号 | 提交 | 范围 | 内容 |
| --- | --- | --- | --- |
| P-8 | 1046191 | api, web | 阶段 7 现场抽奖：主持人凭证、抽奖事务与作废重抽、SSE、大屏页、中奖/抽奖日志导出。见 [phases/phase-7-draw.md](phases/phase-7-draw.md) |
| P-24 | 1046191 | web | 运营后台补齐：页头改密；组织详情中的活动列表与单场人数上限。后端接口沿用阶段 2 / 5 |
