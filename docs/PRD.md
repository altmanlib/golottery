...
| O7 | 品牌装修 | 活动显示名、副标题、主题色、Logo、大屏背景、小程序封面；固定位置换图改字，不做自由排版；各档位均可用 | P0 |
...
| 奖项 | 活动、名称、奖品、人数、顺序 |
| 品牌配置 | 活动、显示名、副标题、主题色、Logo、大屏背景、小程序封面 |
| 素材 | 组织、图片格式、大小、宽高、上传人、上传时间 |
...
| 域名备案与 HTTPS | 正式版无法请求后端与加载素材 | 业务域名 `golottery.ioclub.cn`、素材域名 `golottery-oss.ioclub.cn` 备案并配 HTTPS |
